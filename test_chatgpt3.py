...
if select_mode == 0:
    ...
    ax.quiver(Tbase0[0, 3], Tbase0[1, 3], Tbase0[2, 3], Tbase0[0, 0], Tbase0[1, 0], Tbase0[2, 0], color='r', linewidth=2)
    ax.quiver(Tbase0[0, 3], Tbase0[1, 3], Tbase0[2, 3], Tbase0[0, 1], Tbase0[1, 1], Tbase0[2, 1], color='g', linewidth=2)
    ax.quiver(Tbase0[0, 3], Tbase0[1, 3], Tbase0[2, 3], Tbase0[0, 2], Tbase0[1, 2], Tbase0[2, 2], color='b', linewidth=2)

    # Plotting frame 4 vectors
    ax.quiver(T04[0, 3], T04[1, 3], T04[2, 3], T04[0, 0], T04[1, 0], T04[2, 0], color='r', linewidth=2)
    ax.quiver(T04[0, 3], T04[1, 3], T04[2, 3], T04[0, 1], T04[1, 1], T04[2, 1], color='g', linewidth=2)
    ax.quiver(T04[0, 3], T04[1, 3], T04[2, 3], T04[0, 2], T04[1, 2], T04[2, 2], color='b', linewidth=2)
