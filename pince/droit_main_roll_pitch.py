...
hands = mp_hands.Hands(False, 2)  # Détection des mains
...
try:
    while True:
        ...
        if hand_results.multi_hand_landmarks:
            for indx, hand_landmarks in enumerate(hand_results.multi_hand_landmarks):
                
                if (hand_results.multi_handedness[indx].classification[0].label != "Left"): # the mediapipe classification is flipped
                    pass
