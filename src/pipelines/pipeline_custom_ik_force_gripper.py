                    ...
                    for current_arm in arms_to_process:
                        ...
                        if current_arm.joint_dict:
                            ...
                            if joint in current_arm.joint_dict:
                                try:
                                    # Get current force reading for monitoring
                                    force = current_arm.get_force_reading()
                                    print(
                                        f"Setting gripper position for {joint}: {current_arm.joint_dict[joint]} (Force: {force:.1f}g)"
                                    )
                                    setattr(
                                    ...
                                    print(f"Error setting position for {joint}: {e}")
                            else:
