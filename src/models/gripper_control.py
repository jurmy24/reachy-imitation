...
HANDEDNESS_CERTAINTY_UPPER = (
    0.9  # There's a tradeoff here between whether it recognises
)
        ...
        if results.multi_hand_landmarks:
            for index, hand_landmarks in enumerate(results.multi_hand_landmarks):
                ...
                if certainty < HANDEDNESS_CERTAINTY_LOWER:
                    ...
                    if (
                        certainty < HANDEDNESS_CERTAINTY_UPPER
                        and previous_hand_type[index] != hand_type
                    ):
                        hand_type = "Unknown"
